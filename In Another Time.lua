...
local Window = OrionLib:MakeWindow({Name = "In Another Time [ MONEY UPDATE 🤑 ] UI", HidePremium = false, SaveConfig = true, ConfigFolder = "OrionTest", IntroEnabled = false, IntroText = "Ace hub"})
